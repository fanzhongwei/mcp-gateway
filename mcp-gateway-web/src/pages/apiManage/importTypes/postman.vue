...
import { parsePostmanContent } from '../../../utils/apiImport/sourceImportParsers/postman'
...
const handleParse = async () => {
	...
	try {
		...
		const results = parsePostmanContent(content, props)
		...
		<div class="import-content" :class="{ 'has-selector': showSelector }">
			<div v-if="!showSelector" class="import-panel">
				<div class="import-description">
					上传 Postman Collection（v2.0/v2.1）JSON 文件，解析后可勾选接口导入
				</div>
				<a-upload-dragger
